...
const T = {
    ru: {
        ...
        monthly_b1_title: 'Динамика фонда оплаты труда',
    ...
    en: {
        ...
        monthly_b1_text:  'Monthly SP amount per company',
        ...
        monthly_b4_text:  'Companies where SP or activity dropped sharply',
...
const ONCE_ROWS = [
    ...
    { ru_field: 'Дата договора',            en_field: 'Contract Date',         ru_content: 'Дата подписания договора ЗП проекта',                         en_content: 'Date of SP agreement signing' },
...
const MONTHLY_ROWS = [
    ...
    { ru_field: 'ФОТ за месяц',           en_field: 'SP (Month)',        ru_content: 'Общая сумма зачисленной зарплаты за месяц',                  en_content: 'Total salary amount credited for the month' },
