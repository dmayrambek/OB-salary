...
const TRANSLATIONS = {
    ru: {
        ...
        man_title:'Отчёт, формируемый вручную', man_source:'Фонд оплаты труда для бизнеса + Реестр ЗП проектов', man_badge:'Вручную',
        ...
        p3_title:'Ручное ведение отчетности', p3_text:'Отчёты формируются в Excel вручную — высокий риск ошибок, расхождений и задержек при обновлении данных.',
    ...
    en: {
        ...
        subtitle:'A single request get different data from different sources — impossible to combine without manual effort',
        dateBadge:'March 2026',
        sys_title:'System Report', sys_source:'ABS Colvir + Superset', sys_badge:'Automated',
        man_title:'Manually generated report', man_source:'SP Fund + SP Registry', man_badge:'Manual',
        grp_cards:'Cards', grp_orgs:'Organisations', grp_employees:'Clients',
        grp_fot:'SP Fund Data', grp_registry:'SP Project Registry',
        lbl_visa:'VISA cards', lbl_elcard:'Elcard cards',
        lbl_orgs:'Unique organisations',
        lbl_with_deal:'With SP agreement', lbl_no_deal:'Without agreement',
        lbl_deals_ec:'Elcard agreements', lbl_deals_visa:'VISA agreements',
        lbl_employees:'Client-level data',
        no_data:'no data',
        note_cards:'total cards in report — no breakdown by SP project',
        sys_problem:'No card breakdown by SP project. No data on agreements or clients. Impossible to determine how many of the 556 organisations are actually on a SP project.',
        man_problem:'399 companies in the SP differ from 1,340 unique companies in the register. Data within a single source contradicts itself.',
        problems_title:'Key Problems',
        p1_title:'No client data', p1_text:'Neither source contains information about the number of clients covered by SP projects.',
        p2_title:'No single unified report', p2_text:'Data from both sources diverges. Without a unified system it is impossible to obtain an accurate list of SP project companies.',
