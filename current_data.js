const TRANSLATIONS = {
    ru: {
        ...
        grp_cards:'Карты', grp_orgs:'Организации', grp_employees:'Сотрудники',
        ...
        sys_problem:'Нет разбивки карт по ЗП проектам. Нет данных по договорам и сотрудникам. Невозможно определить сколько из 556 организаций реально на ЗП проекте.',
        man_problem:'399 компаний в ФОТ не стыкуются с 1 340 уникальными компаниями в реестре. Данные внутри одного источника противоречат друг другу.',
        problems_title:'Общие проблемы',
        p1_title:'Нет данных по сотрудникам', p1_text:'Ни один из источников не содержит информацию о количестве сотрудников на ЗП проектах.',
    ...
    en: {
        ...
        grp_cards:'Cards', grp_orgs:'Organisations', grp_employees:'Employees',
        ...
        sys_problem:'No card breakdown by payroll project. No data on agreements or employees. Impossible to determine how many of the 556 organisations are actually on a payroll project.',
        man_problem:'399 companies in the Payroll Fund do not match 1,340 unique companies in the registry. Data within a single source contradicts itself.',
        problems_title:'Key Problems',
        p1_title:'No employee data', p1_text:'Neither source contains information about the number of employees covered by payroll projects.',
